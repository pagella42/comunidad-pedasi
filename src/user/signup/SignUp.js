        ...
        return (
            <div id='sign-up'>
                ...
                <form onSubmit={this.verifyUser}>
                    {this.renderLoading()}
                    <div><span>{t("Full Name")}<input required value= {this.state.user.name} onChange= {this.handleInputChange}  name='name'></input>*</span></div>
                    <div><span>{t("Username")}<input required value= {this.state.user.username} onChange= {this.handleInputChange}  name='username'></input>*</span></div>
